...
`)}function r(e,t,r){let i=new Blob([`﻿`+n(t,r)],{type:`application/vnd.ms-excel;charset=utf-8`}),a=document.createElement(`a`);a.href=URL.createObjectURL(i),a.download=e,a.click(),URL.revokeObjectURL(a.href)}export{r as t};